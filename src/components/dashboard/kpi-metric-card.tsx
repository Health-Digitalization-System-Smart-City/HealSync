...
> = {
  teal: {
    ...
    badge: "bg-teal-50 text-teal-700 border-teal-200/60 dark:bg-teal-500/10 dark:text-teal-300 dark:border-teal-500/20",
  },
  blue: {
    ...
    badge: "bg-blue-50 text-blue-700 border-blue-200/60 dark:bg-blue-500/10 dark:text-blue-300 dark:border-blue-500/20",
  },
  emerald: {
    ...
    badge: "bg-emerald-50 text-emerald-700 border-emerald-200/60 dark:bg-emerald-500/10 dark:text-emerald-300 dark:border-emerald-500/20",
  },
  amber: {
    ...
    badge: "bg-amber-50 text-amber-700 border-amber-200/60 dark:bg-amber-500/10 dark:text-amber-300 dark:border-amber-500/20",
  },
  violet: {
    ...
    badge: "bg-violet-50 text-violet-700 border-violet-200/60 dark:bg-violet-500/10 dark:text-violet-300 dark:border-violet-500/20",
  },
  rose: {
    ...
    badge: "bg-rose-50 text-rose-700 border-rose-200/60 dark:bg-rose-500/10 dark:text-rose-300 dark:border-rose-500/20",
  },
  sky: {
    ...
    badge: "bg-sky-50 text-sky-700 border-sky-200/60 dark:bg-sky-500/10 dark:text-sky-300 dark:border-sky-500/20",
  },
};
...
export function KPIMetricCard({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-border/80 bg-card p-5 shadow-xs transition-all duration-250",
        style.borderHover,
        style.glow,
    ...
    >
      ...
      {detail && (
        <div className="text-muted-foreground mt-3 flex items-center justify-between border-t border-border/50 pt-2.5 text-xs leading-relaxed">
