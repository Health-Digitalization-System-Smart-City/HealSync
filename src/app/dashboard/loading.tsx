    ...
    <div className="space-y-6" role="status" aria-live="polite">
      ...
      <div className="border-border/70 flex flex-col gap-3 border-b pb-6 sm:flex-row sm:items-end sm:justify-between">
        <div className="min-w-0 space-y-2">
          ...
          <div className="h-8 w-64 animate-pulse rounded-lg bg-slate-200 dark:bg-slate-800 sm:h-9" />
          <div className="h-3.5 w-full max-w-xl animate-pulse rounded bg-slate-100 dark:bg-slate-850" />
        </div>
      </div>

      {/* Filter Bar Skeleton */}
      <div className="rounded-2xl border border-slate-200/80 bg-white dark:border-slate-800 dark:bg-slate-900 p-4.5 shadow-xs">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
          <div className="h-9.5 rounded-xl bg-slate-100 dark:bg-slate-800 animate-pulse" />
          <div className="h-9.5 rounded-xl bg-slate-100 dark:bg-slate-800 animate-pulse" />
          <div className="h-9.5 rounded-xl bg-slate-100 dark:bg-slate-800 animate-pulse" />
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900/60 p-5 shadow-xs">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="w-full max-w-md shrink-0 rounded-xl border border-slate-200/60 bg-white/70 dark:border-slate-800 dark:bg-slate-850 p-4 shadow-2xs">
